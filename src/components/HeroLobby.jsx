  ...
  return (
    <div style={{ marginBottom: 6 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}>
        <span style={{ fontSize: 10, color: "#5a4a2a", letterSpacing: 1, fontFamily: "Cinzel, serif" }}>
          {cfg.icon} {cfg.label}
        </span>
        <span style={{ fontSize: 10, color: cfg.color, fontWeight: 700 }}>{value}</span>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 4,
        border: isCurrent ? "1.5px solid #c9a84c"
              : hov       ? "1px solid #4a3a1a"
              : "1px solid #1e1c14",
        ...
        boxShadow: isCurrent ? "0 0 20px rgba(201,168,76,0.08)"
                 : hov       ? "0 4px 16px rgba(0,0,0,0.4)"
                 : "none",
      }}
    >
      {isCurrent && (
      ...
      <div style={{
        ...
        color: "#c9b99a", textAlign: "center", marginBottom: 2,
      }}>
        {hero.name}
      </div>

      <div style={{
        fontSize: 9, color: "#5a4a2a", textAlign: "center",
      ...
      <div style={{
        fontSize: 9, color: "#3a3028", lineHeight: 1.5,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0 }}>
            ...
            {!isXs && (
              <div style={{ fontSize: 10, color: "#3a3028", marginTop: 3, letterSpacing: 1 }}>
          ...
          <button
            ...
            style={{
              flexShrink: 0,
              background: "none", border: "1px solid #2a2218", color: "#5a4a2a",
  ...
  return (
    ...
    >
      <div style={{
        ...
        position: "relative",
        boxShadow: hero
          ? hov ? "0 0 24px rgba(201,168,76,0.1)" : "none"
          : hov ? "0 0 20px rgba(74,223,138,0.06)" : "none",
      }}>
        {/* Número */}
        <div style={{
        ...
        {hero ? (
          <>
            ...
            <div style={{
              ...
              letterSpacing: 1, color: "#c9b99a", textAlign: "center",
            }}>
              {hero.name}
            </div>
            {size !== "sm" && (
              <div style={{ fontSize: 9, color: "#5a4a2a", fontStyle: "italic" }}>
                {hero.class}
              </div>
            )}
            <div style={{ display: "flex", gap: size === "sm" ? 6 : 8, marginTop: 2 }}>
              {["hp","atk","def"].map(k => (
                <div key={k} style={{ textAlign: "center" }}>
                  <div style={{ fontSize: 7, color: "#3a3028" }}>{STAT_CFG[k].icon}</div>
                  <div style={{ fontSize: 8, color: STAT_CFG[k].color, fontFamily: "Cinzel, serif" }}>
                    {hero[k]}
                  </div>
                </div>
              ))}
          ...
          <>
            <div style={{
              width: spriteS * 0.85, height: spriteS * 0.85, borderRadius: "50%",
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ width: isXs ? 36 : 60, height: 1, background: "linear-gradient(90deg, transparent, #3a3028)" }} />
          <div style={{ fontSize: 9, color: "#3a3028", fontFamily: "Cinzel, serif", letterSpacing: 4 }}>
            HERO HUB
          </div>
          <div style={{ width: isXs ? 36 : 60, height: 1, background: "linear-gradient(90deg, #3a3028, transparent)" }} />
        </div>
      ...
      <div style={{
        ...
        {!isXs && (
          <div style={{
            ...
            left: 20, right: 20,
            height: 1,
            background: "linear-gradient(90deg, transparent, #1e1c14 20%, #1e1c14 80%, transparent)",
            pointerEvents: "none",
          }} />
        )}
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            transition: "all 0.2s",
            boxShadow: rosterComplete ? "0 8px 32px rgba(60,109,17,0.25)" : "none",
            whiteSpace: "nowrap",
          }}
          onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow = "0 12px 40px rgba(60,109,17,0.35)";
          }}
          onMouseLeave={e => {
            if (!rosterComplete) return;
